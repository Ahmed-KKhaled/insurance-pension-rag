from .providers import QdrantProvider, ChromaDBProvider, PGVectorProvider
...
class VectorDBProviderFactory:
    ...
    def create(self, provider: str):
        ...
        if provider == VectorDBEnums.CHROMA.value:
            chroma_db_client=self.base_controller.get_database_path(db_name=self.config.VECTOR_DB_PATH)
